...
> 最后更新：2026-08-17 | 状态：Chrome 扩展 + MCP 均已上线
> **⚠️ 定价变更（2026-08-15）**：Pro 从 $29 终身买断 → 订阅制（$2.99/月 或 $19.99/年）。本文档中的 $29/买断制分析为历史决策记录，当前以订阅为准。
...
### 5.2 Pro 版 — 订阅制（扩展，2026-08-15 从买断转订阅）
