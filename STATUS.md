...
> 最后更新：2026-08-20 | 当前版本：v2.0.4（**CWS ✅ 8/19 通过 | Edge ✅ 8/18 通过**）| Glama score A/A/B ✅ | dev.to ✅ | HN 评论 ✅ | awesome-mcp PR ⏳
...
### 待处理风险
- **server/ 代码公开**（2026-08-10 决策：暂不处理，等产品火了再说）— `server/` 目录（许可证 Worker、D1 schema、webhook）在 public 仓库里，fork 者可零成本复制 Pro 商业化闭环。若产品起量，需把 `server/` 移到独立 private 仓库
...
- 2026-08-05 重新提交被拒：6 个月内不能 relaunch（下次可提交：2026-01-14）
...
- **审核通过** — CWS 2026-08-05 ✅ | Edge 2026-08-05 ✅（v1.1.4 全平台上架）
